...
--2015-6-1     1.2       Dong           Fifo readout address incress to 30 bit
-------------------------------------------------------------------------------
...
ENTITY control_interface IS
  PORT (
    ...
    -- Digital I/O
    CONFIG_REG      : OUT std_logic_vector(575 DOWNTO 0); -- thirtytwo 16bit registers
...
ARCHITECTURE a OF control_interface IS
  ...
  SIGNAL sConfigReg : std_logic_vector(575 DOWNTO 0);
